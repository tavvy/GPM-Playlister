...
exports.exit = function(err) {
	console.log(theme.err('Exited due to following error:'));
...
/*
 * FINAL REPORT
 * type: null = likely error, 0 = new playlist, 1 = replace playlist, 2 = new playlist as none to replace
 */
exports.finish = function(report) {
	console.log(theme.success('Finished!\nReport:'));
	console.log(report);
	process.exit(1);
};
